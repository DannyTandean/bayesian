  ...
  <!-- Zero config.table start -->
    <div class="card">
        <div class="card-header">
            <h5>Data Table Izin Karyawan</h5>
        ...
        <div class="card-block">
            <div class="dt-responsive table-responsive">
                <table id="tblIzin" class="table table-striped table-bordered table-sm nowrap" style="width: 100%;">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Action</th>
      ...
      <div class="form-group">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="col-md-6">
                <label for="mulaiIzin" class="block">Mulai Izin :</label>
                <input id="mulaiIzin" class="form-control" type="text" placeholder="Mulai Izin" name="mulaiIzin">
                <div id="errorMulaiIzin"></div>
              </div>

              <div class="col-md-6">
                <label for="akhirIzin" class="block">Akhir Izin :</label>
                <input id="akhirIzin" class="form-control" type="text" placeholder="Akhir Izin" name="akhirIzin">
                <div id="errorAkhirIzin"></div>
              </div>
...
<table class="table invoice-table table-borderless" style="padding-left:0;">
          ...
          <table class="table table-responsive invoice-table invoice-order table-borderless">
              <tbody>
                  ...
                  <tr>
                      <th>Status :</th>
                      <td>
                          <span class="label label-warning" id="status1"></span>
                      </td>
                  </tr>
                  <tr>
                      <th>Id :</th>
                      <td>
                          #<span id="id_izin1"></span>
                      </td>
                  </tr>
              </tbody>
          </table>
          ...
          <div class="table-responsive">
              <table class="table  invoice-detail-table">
                  <tbody>
                      ...
                      <tr>
                          <td>Mulai Tanggal</td>
                          <td><span id="mulaiIzin1"></span></td>
                      </tr>
                      <tr>
                          <td>Sampai Tanggal</td>
                          <td><span id="akhirIzin1"></span></td>
                      </tr>
                      <tr>
  ...
  <div class="row">
      <div class="col-sm-12">
          <p>Melalui Surat Ini Maka Izin Saudara <b class="text-underline">Diterima</b>. Demikian Disampaikan Dan Dapat Dilaksanakan Dengan Baik.</p>
          <p>Terima Kasih</p>
          <br>
          <br>
...
<?php assets_script_custom_aktivitas("izin.js"); ?>
