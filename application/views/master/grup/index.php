    ...
    <div class="card">
        ...
        <div class="card-block">
            <div class="dt-responsive table-responsive">
                <table id="tblGrup" class="table table-striped table-bordered table-sm nowrap" style="width: 100%;">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Grup</th>
...
<?php echo modalSaveOpen(); ?>
    ...
    <?php echo form_open("",array("id" => "formData")); ?>
	    <div class="form-group">
            <label for="Grup" class="block">Grup :</label>
            <input id="Grup" name="grup" type="text" class="form-control">
...
<?php assets_script_custom_master("grup.js"); ?>
