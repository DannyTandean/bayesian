<div class="col-md-12">
    ...
    <div class="card">
        <div class="card-header">
            <h5>Data Table Approval Izin Karyawan</h5>
        ...
        <div class="card-block">
            <div class="dt-responsive table-responsive">
                <table id="tblIzinApproval" class="table table-striped table-bordered table-sm nowrap" style="width: 100%;">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Action</th>
...
<?php assets_script_custom_approval("izin.js"); ?>
