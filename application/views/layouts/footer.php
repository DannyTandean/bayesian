...
<!--sticky js-->
<script type="text/javascript" src="<?php echo base_url(); ?>assets/pages/sticky/js/trumbowyg.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/pages/sticky/js/jquery.minicolors.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/pages/sticky/js/jquery.postitall.js"></script>

<!-- light-box js -->
<script type="text/javascript" src="<?php echo base_url(); ?>assets/bower_components/ekko-lightbox/js/ekko-lightbox.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/bower_components/lightbox2/js/lightbox.js"></script>
...
<script src="<?php echo base_url(); ?>assets/pages/data-table/extensions/responsive/js/dataTables.responsive.min.js"></script>
...
<script type="text/javascript" src="<?php echo base_url(); ?>/assets/bower_components/datatables.net-buttons/js/buttons.colVis.min.js"></script>
<!-- Bootstrap date-time-picker js -->
<script type="text/javascript" src="<?php echo base_url(); ?>assets/pages/advance-elements/moment-with-localess.min.js"></script>
...
<!-- list-scroll js -->
<script src="<?php echo base_url(); ?>assets/bower_components/stroll/js/stroll.js"></script>
...
<!-- <script type="text/javascript" src="<?php //echo base_url(); ?>assets/pages/list-scroll/list-custom.js"></script> -->
...
<!-- script dashboard sticky -->
<?php
    $className = $this->router->fetch_class();
    if ($className == "dashboard") {
        assets_script_custom("dashboard_sticky.js");
    }
?>
...
<!-- clock picker -->
<script type="text/javascript" href="<?php echo base_url(); ?>assets/js/jquery-clockpicker.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/jquery.table2excel.js"></script>

<?php assets_script("script.js"); ?>
