<div class="col-md-12">
	<div class="card">
		...
		<div class="row card-block">
	    	<div class="col-md-12">
		        <ul class="list-view" id="listPemberitahuan">
    			<?php 
    				$no = 1;
    				if(!empty($posts)){ 
    			...
    			<?php 	} 	?>
					        ...
					        <div class="load-more" lastID="<?php echo $post['id']; ?>" style="display: none;">
					        	<center>
					        		<h2 style="color:blue;"><span class="fa fa-spinner fa-spin"></span> 
					        			Loading more...
					        		</h2>
					        	</center>
					        </div>
			...
			?>
				        <div class="load-more" lastID="0">
					        <center><h2 style="color:red;">Pemberitahuan tidak ada.</h2></center>
					    </div>
			<?php 	} 	?>
		        </ul>
	        </div>
...
<?php assets_script_custom("pemberitahuan.js"); ?>