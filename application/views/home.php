                                    ...
                                    <ul class="show-notification row">
                                        ...
                                        <li class="col-sm-3">
                                            ...
                                            <div class="row m-b-20">
                                                <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="<?php echo base_url(); ?>assets/images/mega-menu/01.jpg" alt="Gallery-1">
                                                </div>
                                                <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="<?php echo base_url(); ?>assets/images/mega-menu/02.jpg" alt="Gallery-2">
                                                </div>
                                                <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="<?php echo base_url(); ?>assets/images/mega-menu/03.jpg" alt="Gallery-3">
                                                </div>
                                            </div>
                                            <div class="row m-b-20">
                                                <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="<?php echo base_url(); ?>assets/images/mega-menu/04.jpg" alt="Gallery-4">
                                                </div>
                                                <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="<?php echo base_url(); ?>assets/images/mega-menu/05.jpg" alt="Gallery-5">
                                                </div>
                                                <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="<?php echo base_url(); ?>assets/images/mega-menu/06.jpg" alt="Gallery-6">
                                                </div>
                                            </div>
                                                ...
                                                <div class="user-card-block card">
                                                    <div class="card-block">
                                                        <div class="top-card text-center">
                                                            <img src="<?php echo base_url(); ?>assets/images/widget/user1.png" class="img-responsive" alt="">
                                                        </div>
                                                    ...
                                                    <div class="card-block reset-table p-t-0">
                                                        <div class="table-responsive">
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td><a href="#!"><img class="img-responsive" src="<?php echo base_url(); ?>assets/images/widget/prod1.jpg" alt="chat-user"></a>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td><a href="#!"><img class="img-responsive" src="<?php echo base_url(); ?>assets/images/widget/prod4.jpg" alt="chat-user"></a>
                                                                        </td>
                                                                        <td>Leisure Suit Casual</td>
                                                                        <td>3BSD59</td>
                                                                    ...
                                                                    <tr>
                                                                        <td><a href="#!"><img class="img-responsive" src="<?php echo base_url(); ?>assets/images/widget/prod2.jpg" alt="chat-user"></a>
                                                                        </td>
                                                                        <td>Leisure Suit Casual</td>
                                                                        <td>3BSD59</td>
                                                                    ...
                                                                    <tr>
                                                                        <td><a href="#!"><img class="img-responsive" src="<?php echo base_url(); ?>assets/images/widget/prod3.jpg" alt="chat-user"></a>
                                                                        </td>
                                                                        <td>Leisure Suit Casual</td>
                                                                        <td>3BSD59</td>
                                                                        <td><button type="button" class="btn btn-primary btn-round">Process</button></td>
...
<!-- Calender js -->
<script type="text/javascript" src="<?php echo base_url(); ?>assets/bower_components/moment/js/moment.min.js"></script>
