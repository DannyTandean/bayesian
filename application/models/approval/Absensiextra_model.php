...
class Absensiextra_model extends CI_Model {
	...
	public function setQueryDataTable($search,$where=false)
	{
		...
		$this->db->select("absensi_extra.*,master_karyawan.kode_karyawan, master_karyawan.nama,master_karyawan.shift ,master_karyawan.foto,master_jabatan.jabatan");
	...
	public function getById($id)
	{
		...
		$this->db->select("absensi_extra.*,master_karyawan.kode_karyawan, master_karyawan.nama,master_karyawan.shift ,master_karyawan.foto, master_departemen.departemen, master_jabatan.jabatan");
...
/* End of file Absensiextra_model.php */
/* Location: ./application/models/approval/Absensiextra_model.php */
