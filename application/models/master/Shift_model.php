...
class Shift_model extends CI_Model {
	...
	{
		parent::__construct();
		$this->_table = "master_shift";
		$this->_primary_key = "id_shift";
	}

	public function setQueryDataTable($search,$where)
	{
		$dataSearch = array();
	...
	public function findDataTable($columnsOrderBy,$search,$where)
	{
		$input = $this->input;
		$orderBy = false;
	...
	public function getSaturdayTime()
	{
		$data = array(
										'hari' => "Saturday",
										"shift" => "REGULAR"
...
/* Location: ./application/models/master/Shift_model.php */
