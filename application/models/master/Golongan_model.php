...
class Golongan_model extends CI_Model {
	...
	{
		parent::__construct();
		$this->_table = "master_golongan";
		$this->_primary_key = "id_golongan";
	}
	...
	{
		$this->db->select('master_golongan.*,kode_karyawan');
		$this->db->join('master_karyawan', 'master_golongan.id_golongan = master_karyawan.id_golongan', 'left');
		$this->db->where("master_karyawan.kode_karyawan", $kode);
		$query = $this->db->get($this->_table);
...
/* Location: ./application/models/master/Golongan_model.php */
