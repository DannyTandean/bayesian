...
class Reward_model extends CI_Model {
	...
	{
		parent::__construct();
		$this->_table = "rwd_reward";
		$this->_primary_key = "id_rewards";
	}
	...
	public function setQueryDataTable($search)
	{
		...
		$this->db->join('master_karyawan', 'rwd_reward.id_karyawan = master_karyawan.id');
	...
	public function getById($id)
	{
		...
		$this->db->select("rwd_reward.*,master_karyawan.id,master_karyawan.kode_karyawan, master_karyawan.nama, master_karyawan.foto, master_departemen.departemen, master_jabatan.jabatan");
		$this->db->join('master_karyawan', 'rwd_reward.id_karyawan = master_karyawan.id');
		$this->db->join('master_departemen', 'master_karyawan.id_departemen = master_departemen.id_departemen');
		$this->db->join('master_jabatan', 'master_karyawan.id_jabatan = master_jabatan.id_jabatan');
	...
	public function getRewardPenggajian($start,$end,$id)
	{
		$where = array(
										'tanggal >=' => $start,
										'tanggal <=' => $end,
		...
		$this->db->where($where);
		$this->db->select('rwd_reward.*,SUM(nilai) as nilai');
		$query = $this->db->get($this->_table);
...
/* Location: ./application/models/rwd/Reward_model.php */
