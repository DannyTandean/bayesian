...
class Izin_model extends CI_Model {
	...
	{
		parent::__construct();
		$this->_table = "aktivitas_izin";
		$this->_primary_key = "id_izin";
	}
	...
	public function setQueryDataTable($search,$after=null,$before=null)
	{
		...
		$this->db->join('master_karyawan', 'aktivitas_izin.id_karyawan = master_karyawan.id');
	...
	public function getById($id)
	{
		...
		$this->db->select("aktivitas_izin.*,master_karyawan.id, master_karyawan.kode_karyawan, master_karyawan.nama, master_karyawan.foto, master_departemen.departemen, master_jabatan.jabatan");
		$this->db->join('master_karyawan', 'aktivitas_izin.id_karyawan = master_karyawan.id');
		$this->db->join('master_departemen', 'master_karyawan.id_departemen = master_departemen.id_departemen');
		$this->db->join('master_jabatan', 'master_karyawan.id_jabatan = master_jabatan.id_jabatan');
	...
	public function update($id,$data,$dataNotif,$dataIzinAbsensi=false)
	{
		$this->db->trans_start();
		$this->db->where($this->_primary_key,$id);
		...
		if ($dataIzinAbsensi) {
			if ($data["status"] == "Diterima") {
				$this->db->insert_batch("absensi", $dataIzinAbsensi);
			}
		}
